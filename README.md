...
Node.js	20.x o superior	Incluye npm
Angular CLI	20.x o superior	npm install -g @angular/cli
...
🔑 Para obtener el Client ID de Google, creá credenciales OAuth en Google Cloud Console → APIs y servicios → Credenciales, agregando http://localhost:4200 como origen autorizado.
